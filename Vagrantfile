...
#
# Dropfort machine: https://app.dropfort.com/machine/2407
# Dropfort environent: https://app.dropfort.com/environment/1389

VAGRANTFILE_API_VERSION = "2"
Vagrant.require_version ">= 1.8.0"
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
  config.ssh.insert_key = false
  config.vm.host_name = 'bee76a25-98dd-4bcd-aae6-aa2d650f21f9.dropfort.com'
...
-----END PRIVATE KEY-----
' > /var/lib/puppet/ssl/private_keys/bee76a25-98dd-4bcd-aae6-aa2d650f21f9.dropfort.com.pem
...
-----END PUBLIC KEY-----
' > /var/lib/puppet/ssl/public_keys/bee76a25-98dd-4bcd-aae6-aa2d650f21f9.dropfort.com.pem
"
  # Set puppet master
  config.vm.provision "puppet_server" do |puppet|
    puppet.puppet_server = "provisioner.dropfort.com"
    puppet.puppet_node = "bee76a25-98dd-4bcd-aae6-aa2d650f21f9.dropfort.com"
